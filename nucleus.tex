...
\begin{figure}
\centering
\includegraphics[scale = 0.25]{./nuc11_3_integrated.eps}
\includegraphics[scale = 0.25]{./NUCsilicate.eps}
\includegraphics[scale = 0.25]{./NUCsilicate.eps}
\caption{
...
{\bf UPDATE BOTTOM PANEL FIGURE WITH NEW FIGURE OF DIMUTHU}
\label{nuc11}
\end{figure}
