...
star-bursting or star-forming galaxies selected to cover a wide range in metallicity ($7.1<12+\log{\rm[O/H]}<8.9$).
 For M31 spectra with undetected lines, triangles represent upper (left-pointing triangles) and lower (right-pointing triangles) limits.} % SPW: what sigma?
\label{englII}
\end{figure}
...
Triangles represent upper and lower limits.} % SPW: what sigma?
\label{gordII}
\end{figure}
...
\caption{ PAH equivalent widths versus metallicity. EQWs of the 7.7~$\mu$m feature of the starburst sample from \citet{Engelbracht_2008} are plotted as open circles.
%SPW: what are circles vs squares?
...
In contrast with the nuclear spectrum, the spectrum extracted in the North region (offset by XX \arcsec from the center; % complete
...
found $\gamma810 =-0.08\pm 0.06$.  This is  to be compelted % TBD
