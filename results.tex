...
%MLNA: Fig 12 caption -- what is meant by "dividing each EQW by their weighted average over all regions."  -- why do you normalize in this way?
\begin{figure}
\centering
...
%SPW: Sec 4.1 par 3: atomic lines need ionizing photons.  The regions observed were not selected to have H II regions in them, and they will have random amount of H II and therefore of atomic lines.  I don't think more needs to be said, but perhaps someone else will have some clever analysis.
%
...
% D: I think we can remove this section. I talked to Els about this. She was fine with removing it.

\subsection{Aromatic equivalent widths versus metallicity}
\label{sect:eqw_met}
%SPW: Sec 4.2 par 1: need a few references for those "many studies."  Use a review or summary article if there's a good one.
% PB: done?
% Yes
...
%SPW: Sec 4.2 par 2/3: explanation of metallicity methods is confusing.  If no one else volunteers, I can look back at the references and try to figure out a clearer explanation.  Let me know if you want me to do that.
%D: Have to reply to Steven about this. I don't know how to explain this properly.
...
%SPW: Sec 4.2 par 4: while there's no metallicity dependence, 3 of 8 regions have very low PAH.  Which regions?  Any idea why?  Is it just stellar light contamination, or is something fundamental happening?
...
% D :Pauline, what is your openion about this comment ?
\begin{figure}
\centering
...
%SPW: When the comparison samples are introduced in Sec 4, say a few words about what they are and how they were selected.
% D : I have labeled the galaxies in the figure caption. I changed the last - 1 sentence a bit so that it says why they are selected.
...
%
% D: Edited the second sentence and got rid of the South East region.

Figure \ref{nuc11} shows the integrated intensity map of 11.3~$\mu$m emission around the nucleus. It can be observed that the centre of the nucleus
