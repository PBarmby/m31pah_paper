...
In contrast with the nuclear spectrum, the spectrum extracted in the North region (offset by \arcsec from the center, see Sect.~\ref{obs:nuc} for details;
...
compares the spectra extracted from these two regions (see~Section~\ref{obs:nuc}). Silicate emission is not very common in
