...
% need info somewhere about Engelbracht and Gordon samples
...
For reference, we have added this to the starburst sample of \citet{Engelbracht_2008} and the H~{\sc ii} regions in M101 of \citet{Gordon:2008lr}. 
...
% some re-jigging of paragraphs needed here

The centre of M31 has a complicated physical structure. It hosts a very inactive supermassive black hole with a mass of 
$0.7-1.4 \times 10^8$~M$_{\sun}$ \citep{Bacon2001, Bender2005} and it also has a lopsided nuclear disk  with two stellar 
components and an A-star cluster \citep{Lauer1993}.
% think we need some more detail here about MIR obs of M31 nucleus
The spectra of the nucleus from both {\em Spitzer} and ISOCAM (Figure~\ref{ISOnIRS}) show similar characteristics in the mid infrared wavelengths. 
Emission from the nucleus is missing the most common 6--8~$\mu$m PAH features while showing considerable emission around 11.3~$\mu$m. 
