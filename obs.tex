...
\caption{$8 - 24/70 - 160$ $\mu$m colour-colour diagram of M31 obtained from IRAC and MIPS. Colour-coding of points represents
...
cover those regions, subject to a 24$\mu$m brightness cut. The triangles indicate the regions we observed.}
\label{colourmaps}
\end{figure}
...
and MIPS \citep{gordon06a} maps to the same resolution and constructing an $8 - 24/70 - 160$ $\mu$m colour-colour diagram.
...
% EP not so sure about putting this section here.
...
(see Figure \ref{silicate} (bottom), a continuum-subtracted image which shows the 9--11~$\mu$m integrated emission).
