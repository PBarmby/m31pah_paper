...
and MIPS \citep{gordon06a} maps to the same resolution and constructing an $8 - 24/70 - 160$ $\mu$m colour-colour diagram (Figure~\ref{colurmaps}).
...
% SPW: give source of other metallicities (Sanders?)
}
\end{minipage}
\end{table*}
...
%SPW: Sec 2.4 makes the reader expect a comparison between the nuclear and other spectra, but in fact there is none. ÊIt bothers me a little that the nuclear spectra aren't given in the same form as Fig 7, but I can live with that. I think perhaps the easiest thing is simply to move the paragraph now Sec 2.4 into Sec 4.4 and do a little rephrasing.
% EP not so sure about putting this section here. SPW also suggests section 4.4
\subsection{Nuclear Spectra}
\label{obs:nuc}

The extracted IRS spectra of the M31 nuclear region 
%look different from most of the other spectra, with
shows a blue continuum, PAH features weak or absent at 6--8~$\mu$m  but detectable at 11.3~$\mu$m.
