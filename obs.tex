...
% compare with IRS image -- are we seeing different things in ISOCAM image?
%(do we even want to include this figure?)
% SPW: Fig 5: mention "negative image" (if that's what it is).  Also mention spectral band of image.
% PB -- just noticed that the label in the figure says "ISOCVF" -- what??
\begin{figure}
\centering
