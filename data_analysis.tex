...
% PB: Dimuthu please check that above sentence is correct.
...
Here $I_{\nu} =I_{\nu,{\rm feature}}+ I_{\nu, {\rm cont}} $. 
%MLNA:  Also, it is unclear from the text why you write it this way instead of just putting I(nu)_feature in the numerator and then having to explain your notation in the text
...
%PB: I dont understand the following sentence.	
